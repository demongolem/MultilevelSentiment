...
from lib.data_utils import TextReader, ALPHABET_SIZE
from lib.ops import linear, conv2d, softmax
...
class LSTM(object):
                ...
                with open(TRAIN_SET, 'r', encoding='utf-8') as f:
                    ...
                    for minibatch in reader.iterate_minibatch(BATCH_SIZE, dataset=TRAIN_SET):
                        ...
                        if batch % 500 == 0:
                            ...
                            with open(TEST_SET, 'r', encoding='utf-8') as ff:
    ...
    def predict_sentences(self, sentences):
        ...
        with open(TEST_SET, 'r', encoding='utf-8') as f:
            ...
            try:
                p = self.sess.run([pred], feed_dict={self.X: batch_x, self.Y: batch_y})
            except:
                print('yeah')
    ...
    def categorize_sentences(self, sentences):
        ...
        def fill_list(listy, length):
            while len(listy) != length:
                listy.append('empty sentence.')
            return listy
